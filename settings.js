...
/*
	* Create By Tylor White
	* Follow https://github.com/GlobalTechInfo
	* Whatsapp : https://whatsapp.com/channel/0029VagJIAr3bbVBCpEkAM07
*/

//~~~~~~~~~~~~< QUEEN SIA V1 SETTINGS >~~~~~~~~~~~~\\


global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(',').map(v => v.trim()) : ['254748840328'];

global.packname = process.env.PACKNAME || 'Tylor White';
global.author = process.env.AUTHOR || 'Tylor White';
global.botname = process.env.BOT_NAME || '𝑸𝑼𝑬𝑬𝑵 𝑺𝑰𝑨-𝑽𝑰';
...
global.number_bot = process.env.BOT_NUMBER 14509437111 || '';

global.my = {
	yt: process.env.MY_YOUTUBE || 'https://youtube.com/@queensia-254?si=GJW7mGvjBjKssGmS',
	gh: process.env.MY_GITHUB || 'https://github.com/QUEENSIA/QUEEN-SIA-MD',
	gc: process.env.MY_GROUP || 'https://chat.whatsapp.com/Idv1Je7vuQQLVnObAdEdkW?mode=ac_t',
	ch: process.env.MY_CHANNEL || '120363276154401733@newsletter'
}
global.limit = {
	free: 100,
	premium: 999,
