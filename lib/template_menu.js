...
╭≪━─━─━─━─◈─━─━─━─━≫
♢─┴─彡⍑*𝗨𝗦𝗘𝗥 𝗜𝗡𝗙𝗢*⍊彡
├ *𝗡𝗔𝗠𝗘* : ${m.pushName ? m.pushName : 'No Name'}
├ *𝗨𝗦𝗘𝗥* : ${options.isVip ? '𝗩𝗜𝗣' : options.isPremium ? '𝗣𝗥𝗘𝗠𝗜𝗨𝗠' : '𝘍𝘙𝘌𝘌'}
├ *𝗟𝗜𝗠𝗜𝗧* : ${options.isVip ? '𝗩𝗜𝗣' : (db.users[m.sender]?.limit ?? 0)}
├ *𝗛𝗘𝗟𝗔* : ${db.users[m.sender] ? db.users[m.sender].money.toLocaleString('en-US') : '0'}
╰≪━─━─━─━─◈─━─━─━─━≫彡
╭≪━─━─━─━─◈─━─━─━─━≫
♢─┴─彡⍑*𝗕𝗢𝗧 𝗜𝗡𝗙𝗢*⍊彡
├ *𝗕𝗢𝗧 𝗡𝗔𝗠𝗘* : ${global.botname || 'Bot'}
├ *𝗢𝗪𝗡𝗘𝗥* : @${(global.owner && global.owner[0]) ? global.owner[0].split('@')[0] : 'owner'}
├ *𝗠𝗢𝗗𝗘* : ${qasim.public ? 'Public' : 'Self'}
├ *𝗣𝗥𝗘𝗙𝗜𝗫* : ${db.set && db.set[options.botNumber]?.multiprefix ? '⍑𝗠𝗨𝗟𝗧𝗜-𝗣𝗥𝗘𝗙𝗜𝗫⍊' : ' *' + prefix + '*'}
╰≪━─━─━─━─◈─━─━─━─━≫彡
╭≪━─━─━─━─◈─━─━─━─━≫
♢─┴─彡⍑*𝗗𝗔𝗧𝗘 𝗔𝗡𝗗 𝗧𝗜𝗠𝗘*⍊彡
├ *𝗗𝗔𝗧𝗘* : ${date}
